...
void _lv_disp_refr_timer(lv_timer_t * tmr)
{
    ...
    if(perf_label == NULL) {
        ...
        //lv_obj_set_style_pad_top(perf_label, 1, 0);
        //lv_obj_set_style_pad_bottom(perf_label, 1, 0);
        //lv_obj_set_style_pad_left(perf_label, 1, 0);
        //lv_obj_set_style_pad_right(perf_label, 1, 0);
